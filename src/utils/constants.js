...
export const BRANCH_INFO = {
  Gaborone: {
    ...
    address: 'CBD, Zambezi Building, 5th Floor',
    phone: '+267 318 1888',
  ...
  Francistown: {
    ...
    address: 'Behind Galo Mall, at the T-junction, Francistown Records Road',
    phone: '+267 247 0685',
  ...
  Maun: {
    name: 'Maun Branch',
    address: 'Opposite Shell, above Lewis Building, upstairs on the right',
    phone: '+267 686 0182',
  ...
  Palapye: {
    name: 'Palapye Branch',
    address: 'Riverview Mall, next to Choppies, Office 08',
    phone: '+267 492 5077',
  ...
  Phikwe: {
    ...
    address: 'Lesedi Mall, Shop 20, next to Access Bank',
    phone: '+267 265 0038',
...
export const COMPANY_PROFILE = {
  ...
  businessesAssisted2025: '2,000+ businesses assisted across Botswana in 2025',
  whyChooseTicano: [
    'Fast response times',
    'Flexible financing structures tailored to each client',
    'Financing for international quotations and imported goods',
    'Personalised, relationship-focused service',
    'Extensive experience in Purchase Order, Contract and Project Financing',
  ],
};
...
export const FAQS = [
  ...
  { q: "What are the interest rates?", a: "Our financing rates range from 6.5% to 8.5%, depending on the amount requested and the nature of the transaction." },
  { q: "How long does the approval process take?", a: "We aim to assist clients within 24 hours of receiving all the required documentation." },
  ...
  { q: "Can I apply for both domestic and international transactions? Can Ticano finance purchases from suppliers outside Botswana?", a: "Yes. Ticano is innovative in our approach to both domestic and international transactions. We can finance international quotations and purchases, allowing businesses to source goods and equipment from suppliers outside Botswana, and we have experience structuring solutions for import and export scenarios." },
  ...
  { q: "Is there a minimum or maximum amount? Is there a minimum or maximum financing amount?", a: "No. We do not have a minimum or maximum financing limit. Each application is assessed individually to ensure the project remains financially viable and allows the client to earn a reasonable profit." },
...
// Normalises a Botswana number (or anything close to it) into the
// digits-only, country-code-prefixed form wa.me needs, e.g.
// "71 663 068" / "071663068" / "+267 71663068" -> "26771663068".
