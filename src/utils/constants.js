...
export const FAQS = [
  ...
  { q: "What is your mission?", a: "Our mission is to ensure no business is held back by cash flow. As your business grows, we deliver the funds. We believe in the power of SMEs and provide the financial tools they need to fulfil orders, grow their client base, and scale." },
  ...
  { q: "How do I opt in to WhatsApp updates?", a: "Go to your profile in the Client Portal and toggle on WhatsApp notifications. You will receive real-time updates on your complaint status, appointment reminders, and important account updates directly on WhatsApp." },
  { q: "Can I receive birthday greetings from Ticano?", a: "Yes! Go to the Birthday Messages tab in your Client Portal to opt in. You can choose to receive your birthday greeting via WhatsApp, Email, or both. It is a small gesture from us to show we value our clients." },
