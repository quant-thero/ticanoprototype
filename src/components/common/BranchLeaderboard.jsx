...
export default function BranchLeaderboard() {
  ...
  // Non-directors only see their own branch card
  if (!isDirector) {
    const myBranch = BRANCH_DATA.find(b => b.branch === user?.branch) || BRANCH_DATA[0];
    const myRank   = BRANCH_DATA.sort((a,b) => b.score - a.score).findIndex(b => b.branch === myBranch.branch) + 1;
    return (
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-gray-600 dark:text-gray-300 mt-0.5">
              Ranked <strong>#{myRank}</strong> of 5 branches this week
            </p>
