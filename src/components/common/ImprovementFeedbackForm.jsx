...
import { submitImprovementFeedback } from '../../services/supabaseApi';
...
export default function ImprovementFeedbackForm({ author, defaultBranch, onSubmitted }) {
  ...
  const submit = () => {
    ...
    submitImprovementFeedback({ category, text, branch: branch || null, anonymous, author })
      ...
      .catch((err) => {
        console.error('[ImprovementFeedbackForm]', err);
        toast.error(err?.message || 'Could not send your suggestion, please try again');
      })
